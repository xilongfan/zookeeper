...
Prefix: %{_pid_dir}
Prefix: %{_var_dir}
Requires: chrpath, sh-utils, textutils, /usr/sbin/useradd, /usr/sbin/usermod, /sbin/chkconfig, /sbin/service, java >= 1.7
AutoReqProv: no
Provides: zookeeper
...
chrpath --delete ${RPM_BUILD_DIR}/%{_bindir}/cli_mt
chrpath --delete ${RPM_BUILD_DIR}/%{_bindir}/cli_st
chrpath --delete ${RPM_BUILD_DIR}/%{_bindir}/load_gen
...
cp -a ${RPM_BUILD_DIR}/%{_final_name}/src/c/include/* ${RPM_BUILD_DIR}%{_include_dir}
